...
for idx, perc in enumerate(percentages):
    ...
    try:
        ...
        model = NMF(n_components=rank, init='random', solver='cd', max_iter=1500, random_state=42)
        ...
        compressed_image_path = f'results/als_compressed_rank_{rank}_perc_{int(perc * 100)}.jpg'
...
results_df.to_csv('als_results.csv', index=False)
print("Processing complete. Results saved to 'als_results.csv'.")
